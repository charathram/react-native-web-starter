      ...
      <View style={styles.app}>
        <View style={styles.header}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.title}>React Native Web App | Omaha Code</Text>
        </View>
        <Text style={styles.text}>
          Learn how to create an app built with Create React App and React
          Native for Web, with code included.{" "}
          <Link href="https://omahacode.com/">Create React App</Link> and{" "}
